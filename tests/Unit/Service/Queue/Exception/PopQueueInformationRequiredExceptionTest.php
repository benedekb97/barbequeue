...
#[CoversClass(PopQueueInformationRequiredException::class)]
class PopQueueInformationRequiredExceptionTest extends KernelTestCase
{
    #[Test]
    public function itShouldReturnPassedQueue(): void
    {
        $exception = new PopQueueInformationRequiredException(
