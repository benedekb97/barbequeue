...
#[CoversClass(DeploymentStartedPrivateMessageFactory::class)]
class DeploymentStartedPrivateMessageFactoryTest extends KernelTestCase
{
    ...
    public function itShouldCreatePrivateMessage(): void
    {
        ...
        $factory = new DeploymentStartedPrivateMessageFactory();
        ...
        $this->assertSectionBlockCorrectlyFormatted(
            'userLink has started their deployment of `description` to `repositoryName`',
            $blocks[0],
            expectedAccessory: [
                'text' => [
                    'type' => 'plain_text',
                ...
                'type' => 'button',
                'action_id' => 'more-information-button',
                'url' => 'link',
            ],
        );
    }
