...
#[CoversClass(DeploymentCancelledPrivateMessageFactory::class)]
class DeploymentCancelledPrivateMessageFactoryTest extends KernelTestCase
{
    ...
    public function itShouldCreatePrivateMessage(): void
    {
        ...
        $factory = new DeploymentCancelledPrivateMessageFactory();
        ...
        $this->assertSectionBlockCorrectlyFormatted(
            'userLink\'s deployment of `description` to `repositoryName` has been cancelled!',
            $blocks[0],
        );
    }
}
